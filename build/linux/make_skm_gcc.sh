...
#export LD_LIBRARY_PATH="/usr/local/home/junchulk/csmp/csmp-api-library/bin/linux/"
...
bjam -j32 --toolset=gcc --build-type=complete --layout=system optimization=speed link=shared threading=multi cxxflags="-std=c++11"
