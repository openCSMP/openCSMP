  ...
  do {
    ...
    //TRIANGLE models
      ...
      do {
        ...
        cerr << "      8.) SKUA_split_boundary_layers" << endl;
        cerr << "      9.) SKUA_split_boundary_layer_with_well" << endl;
        cerr << "      10.) SKUA_split_boundary_surface" << endl;
        cerr << "      11.) build all above models" << endl;
        cerr << "      12.) specify another model name" << endl;
        uint32_t sub_option(0U);
        cin >> sub_option;
        ...
        else if (sub_option == 8) BuildFromSKUAModel<3U>("SKUA_split_boundary_layers");
