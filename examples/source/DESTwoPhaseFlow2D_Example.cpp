...
void DESTwoPhaseFlow2D_Example::Run()
{
    ...
    if (!multi_component)
      ...
      DEStransport = new TwoPhaseMultiComponentDESTransport<2U,CO2H2O_FunctionsModule1>(model, "Model", with_capillary_spreading, with_gravity_forces, false, PEP_parameter, Courant_multiplier);
