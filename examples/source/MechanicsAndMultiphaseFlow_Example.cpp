...
void MechanicsAndMultiphaseFlow_Example::Specifications()
{
  SetTitle( "Mechanics combined with multiphase fluid flow" );
  SetDifficulty( 3 );
  SetCategory( "Simulation of Physical Processes" );
  AddAuthor( "SKM" );
  AddDescription( "Linear elasticity combined with failure criteria, and multiphase flow to simulate resource storage/extraction processes" );
  AddDescription( "source in: MechanicsAndMultiphaseFlow_Example.cpp" );
  AddRequirement( "input file set: 'blunt30deg.1', blunt30deg.1-configuration.txt, MechanicsAndMultiphaseFlow_Example-variables.txt");
}
...
*/
void MechanicsAndMultiphaseFlow_Example::Run()
{
    ...
    // 'MechanicsAndMultiphaseFlow_Example-variables.txt' is the text file that defines the variables used in this example
    Model<2U>  model( mesh_container, "MechanicsAndMultiphaseFlow_Example-variables.txt" );
    ...
    string variable_file = "MechanicsAndMultiphaseFlow_Example-variables.txt";
...
*/
void MechanicsAndMultiphaseFlow_Example::SteadyStatePressure( Model<2U>& model )
 {
...
void MechanicsAndMultiphaseFlow_Example::PrintModelProperties( const Model<2U>& model )
 {
    cout << "\n==================================================================================================";
