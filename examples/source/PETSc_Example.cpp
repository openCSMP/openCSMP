...
void PETSc_Example::Run()
{
  ...
  // ---------------------------------------------------------------------------------------
    ...
    bool  restricted_to_rock      =  true; // stdio.RecordLogicalChoice("Would you like to restrict computation to group 'rock'");
...
//    settings.SetRelativeTolerance(1.0e-10);
//    settings.SetMaximumIterations(1000);
//    settings.SetMonitorTrueResidual(true);
