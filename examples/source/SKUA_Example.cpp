...
void SKUA_Example::Run()
{
  ...
  do{
      ...
      bool diag_only = stdio.YesNo(
          "Do you only want to run diagnostics on model " + input + " instead of"
          " running a full example?"
      );
      if( diag_only ) {
          return ImportModelAndRunChecks( input );
      }
...
void SKUA_Example::ImportModelAndRunChecks( const string& model_name ) {
...
void SKUA_Example::RunChecks( const Model<3U>& model ) {
