#include "SteadyStatePressure_Example.h"
...
{
  SetTitle( "Steady-state fluid pressure computation" );
  SetDifficulty( 3 );
...
/** ******************************************************************************************
  ...
  // (1) 2D steady-state calculation of fluid pressure distribution using structured triangular
  //     element meshes generated by CSMP's Triangulator from color-coded bitmaps.
  //     Linear finite element interpolation is used and Dirichlet essential
  //     conditions  are applied.
  //
  //     Use 'granite_model1' as input geometry (needs 100MB of RAM memory)
  //
