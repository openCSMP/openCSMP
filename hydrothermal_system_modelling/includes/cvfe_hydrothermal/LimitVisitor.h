...
#ifndef LIMIT_VISITOR_H
#define LIMIT_VISITOR_H
...
class LimitVisitor : public Visitor<dim> {
  public:
    LimitVisitor( Model<dim>&, 
  ...
  private:
    ...
    csmp::Index var_key_, T_key_;
    ScalarVariable var, T;
    double min_val, max_val;

};

  /**
     @class LimitVisitor LimitVisitor.h
	 ...
	 Change name to NodalLimitVisitor?
