...
#ifndef   H2ONaClThermalEquilibrator_Fluid_Only_H
#define   H2ONaClThermalEquilibrator_Fluid_Only_H
...
namespace csmp
{
class H2ONaClThermalEquilibrator_Fluid_Only
{
public:
    H2ONaClThermalEquilibrator_Fluid_Only(
...
/**
     @class H2ONaClThermalEquilibrator_Fluid_Only.h "eos/h2o_nacl/H2ONaClThermalEquilibrator_Fluid_Only.h" (preliminary)
     ...
     H2ONaClThermalEquilibrator_Fluid_Only performs an isobaric thermal equilibration between a mass of rock and a mass of fluid (from the system H2O-NaCl) given a total enthalpy for this system.
     ...
     @section usage Usage
     Construct an instance of H2ONaClThermalEquilibrator_Fluid_Only with references to the following properties (units are given in square brackets) as constructor arguments:
     ...
     H2ONaClThermalEquilibrator_Fluid_Only is typically used by NaClH2OPropertiesVisitor.
