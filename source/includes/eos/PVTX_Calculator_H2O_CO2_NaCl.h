...
class PVTX_Calculator_H2O_CO2_NaCl {
  ...
  private:
    ...
    double MaxEntryPressureOfParentElements( const Node<dim>* ) const;

  private:
    // constants
    const variables::VariableSet_CO2GeoSequestration& props_;
    static constexpr double rhoNaCl_ = 2170.;             ///< density = 2170 kg/m3
    ...
    std::vector<double>  IPOL_;                           ///< for the interpolation of properties
