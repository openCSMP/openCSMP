...
class PoreVolumeVisitor : public Visitor<dim> {
  public:
    ...
    virtual ~PoreVolumeVisitor();
    
    virtual void Visit( Node<dim>* ); // Application level and target are set to NODE in the constructor.
  	virtual void Visit( Region<dim>* ); // Application level and target are set to NODE in the constructor.
