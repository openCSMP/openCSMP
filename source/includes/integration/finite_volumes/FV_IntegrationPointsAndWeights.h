...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::SectorIntegrationPoints( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::SectorIntegrationWeights( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::FacetIntegrationPoints( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::FacetIntegrationWeights( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::ProjectionWeights( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::FacetNormals( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::FacetsSurroundingNode( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::EdgePairs( 
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::EdgeMidpoints(std::vector<Point<dim> >& rst_facet_edge_midpoints)
{
   rst_facet_edge_midpoints = m_facet_edge_midpoints;
}
		  
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::Barycenter( Point<dim>& rst_barycenter )
{
	rst_barycenter = m_barycenter;
}

template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::FacetPoints( std::vector<std::vector<Point<dim> > >& rst_facet_points )
{
   rst_facet_points = m_facet_points;
}

template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::SectorPoints(
...
template<size_t dim>
inline void FV_IntegrationPointsAndWeights<dim>::SectorEdgePairs( 
