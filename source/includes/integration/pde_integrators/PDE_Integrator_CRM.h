#ifndef CSMP_PDE_INTEGRATOR_CRM_H
#define CSMP_PDE_INTEGRATOR_CRM_H
...
class PDE_Integrator_CRM {
  public:
    ...
    PDE_Integrator_CRM( const PDE_Integrator_CRM& ) = delete;
    /// do not assign
    PDE_Integrator_CRM& operator=( const PDE_Integrator_CRM& ) = delete;
  ...
  // TODO: refactor: rename methods Accumulate and LateAccumulate and let overloading take care of name resolution
    ...
    CompressedRowMatrix   G_;           ///< solution matrix
...
#endif /* CSMP_PDE_INTEGRATOR_CRM_H */
