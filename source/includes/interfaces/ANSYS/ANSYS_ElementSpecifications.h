...
class ANSYS_ElementSpecifications {
  public:
    ...
    static CSMP_FEM_TYPE  CSMP_TypeFrom_ANSYS_Type( int8_t ANSYS_finite_element_type, bool isoparametric, uint32 dim );
    ...
    static std::string    CSMP_TypeNameFrom_ANSYS_Type( int8_t ANSYS_finite_element_type, bool isoparametric, uint32 dim );
