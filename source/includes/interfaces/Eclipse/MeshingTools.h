...
/**
    Collection of functions that process correctly numbered finite-element cells from the supplied point vectors. (numbered to size_t)
*/
...
size_t doesEdgeExist( std::set<std::set<size_t> >& additional_edges, std::vector<size_t>& ids, GridNode* pt0, GridNode* pt1, GridNode* pt2, GridNode* pt3 );
