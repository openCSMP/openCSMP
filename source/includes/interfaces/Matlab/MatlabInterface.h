...
class MatlabInterface {
  public:
    ...
    void ExtractAndWrite1DVariableProfileAlongX( Model<2U>&, double64 distance, const char* name, const char* variable, long step );
    void ExtractAndWrite1DVariableProfileAlongY( Model<2U>&, double64 distance, const char* name, const char* variable, long step );
