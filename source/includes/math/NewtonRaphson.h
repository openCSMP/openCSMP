...
class NewtonRaphsonSolve0 {
 ...
 public:
  ...
  void set_d2f( real (functor<dim>::*d2f)(real)) {
    _d2f = d2f;
  }
  ...
  functor<dim>& get_functor() { return _F;}
  ...
  NewtonRaphsonSolve0(
    ...
    functor<dim>& F,
    real (functor<dim>::*f)(real),
    real (functor<dim>::*df)(real),
    real (functor<dim>::*d2f)(real) = NULL,
    real fsolve = 0,
