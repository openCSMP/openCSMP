...
#define DATA_OFFSET_IP DATA_OFFSET_TO_IP + ip * idx.integrationPointVariables.ipvCell.totalDataDepth + idx.dataOffset

#define FLAG_OFFSET_TO_IP idx.localVariables.totalFlagDepth 

#define FLAG_OFFSET_IP FLAG_OFFSET_TO_IP + ip * idx.integrationPointVariables.ipvCell.totalFlagDepth + idx.flagOffset


// element/face/interface finite volume (sector/facet) integration point offsets

#define DATA_OFFSET_TO_FVIP idx.localVariables.totalDataDepth + IPS_SI * idx.offsetFactorSimplex * idx.integrationPointVariables.ipvCell.totalDataDepth\
...
#define FLAG_OFFSET_TO_FVIP idx.localVariables.totalFlagDepth + IPS_SI * idx.offsetFactorSimplex * idx.integrationPointVariables.ipvCell.totalFlagDepth\
