...
namespace csmp {
  ...
  directly from the MeshManager. This region can be set but is hidded in the sense of C++
...
class RegionInterface
  ...
  protected:
    ...
    std::string                               masterRegion_;   ///< region that is used to form other regions from (non-unique)
