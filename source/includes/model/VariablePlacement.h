...
template<> struct ElementInterpolatorDispatch<from,to> { static constexpr ElementInterpolatorType TYPE = interp; };
  ...
  CSMP_ELEMENT_INTERPOLATOR_DISPATCH(MODEL,SECTOR_INTEGRATION_POINT,FE_READ_MODEL)
  ...
  CSMP_ELEMENT_INTERPOLATOR_DISPATCH(FACET_INTEGRATION_POINT,ELEMENT,FE_FIP_TO_ELMT)
  CSMP_ELEMENT_INTERPOLATOR_DISPATCH(SECTOR_INTEGRATION_POINT,ELEMENT,FE_SIP_TO_ELMT)
  CSMP_ELEMENT_INTERPOLATOR_DISPATCH(ELEMENT_INTEGRATION_POINT,ELEMENT,FE_EIP_TO_ELMT)
