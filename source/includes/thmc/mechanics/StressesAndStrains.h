#ifndef STRESSES_AND_STRAINS_H
#define STRESSES_AND_STRAINS_H
...
@class StressesAndStrains<3U> StressesAndStrains<3U> "mechanics/StressesAndStrains.h"
@author S.K. Matthaei
@date 2000
