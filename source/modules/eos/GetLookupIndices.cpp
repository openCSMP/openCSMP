...
/*    if(     p <=   20.0e0){ p_res =   0.5; }    
	...
	// 11.1.2016 PW -> change from bar to Pa -> check with Thomas
	if(     p <=   20.0e5){ p_res =   0.5e5; }
	else if (p <= 210.0e5){ p_res = 1.0e5; }
	else if (p <= 215.0e5){ p_res = 0.5e5; }
	else if (p <= 225.0e5){ p_res = 0.1e5; }
	else if (p <= 230.0e5){ p_res = 0.5e5; }
	else if (p <= 250.0e5){ p_res = 1.0e5; }
	else if (p <= 300.0e5){ p_res = 2.0e5; }
	else if (p <= 400.0e5){ p_res = 5.0e5; }
	else if (p <= 700.0e5){ p_res = 10.0e5; }
	else if (p <= 1000.0e5){ p_res = 25.0e5; }
	else if (p <= 2000.0e5){ p_res = 50.0e5; }
	else if (p <= 5000.0e5){ p_res = 100.0e5; }
	else{ p_res = 500.0e5; }
	return p_res;
  }
