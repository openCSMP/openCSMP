...
namespace csmp
{
                                                  ...
                                                  const int& property_index )
  {
	...
	// PW
    // J.M. (06-06-2017) Re-instated mole-fraction-based calculation due to GetCompositionIndex()
        ...
        if (!outfile.is_open())
          {
            ...
            csmp_error.Note(FATAL_ERROR,"H2ONaClLookup::BuildSimpleTable(...)","could not find it for writing, please stop program and debug !"," ");
            //cin  >> yesno;
          }
        else
          {
        ...
        if (!outfile1.is_open())
          {
            ...
            //char yesno;
            cerr << "or enter any key to continue (simulation likely to crash or give wrong results!) :";
            csmp_error.Note(FATAL_ERROR,"H2ONaClLookup::BuildTable1(...)","could not open it for writing, please stop program and debug !"," ");
            //cin  >> yesno;
          }
        else
          {
        ...
        if( !outfile2.is_open() )
          {
            ...
            //char yesno;
            //cerr << "or enter any key to continue (simulation likely to crash or give wrong results!) :";
            csmp_error.Note(FATAL_ERROR,"H2ONaClLookup::BuildTable2(...)","could not find it for writing, please stop program and debug !"," ");
            //cin  >> yesno;
          }
        else
          {
        ...
        if (!outfile0.is_open())
          {
            ...
            //char yesno;
            //cerr << "or enter any key to continue (simulation likely to crash or give wrong results!) :";
            csmp_error.Note(FATAL_ERROR,"H2ONaClLookup::BuildTable0(...)","could not open it for writing, please stop program and debug !"," ");
            //cin  >> yesno;
          }
        else
          {
