        ...
        //        / 
        ...
        else
          {
            ...
            if( (tcurrent <= vlh_liquid.Tmax()) && state_iB == V && state_iD == LH ) return NearVLHInterpolationLowT(property_index);
              ...
              {
                char yesno;
                cout << "\n HaliteLiquidusLookup::missed to find interpolation type in case 2, returning bogus value ...\n";
                cout << state_iA << "\t" << state_iB << "\t" << state_iC << "\t" << state_iD << endl;
                cout << "conditions were : tcurrent = " << tcurrent << ", pcurrent = " << pcurrent << endl; 
                throw csmp::Exception( FATAL_ERROR, "HaliteLiquidusLookup::ValueOf:","missed to find interpolation type in case 2, returning bogus value." );
                return 9.9e99;
              }
          }
      }
