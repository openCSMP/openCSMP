...
namespace csmp
{
  VLH_HaliteLookup::VLH_HaliteLookup(const double64& externaltemperature)
  ...
  double64 VLH_HaliteLookup::Temperature(){     return ValueOf(temperature_index); }
  double64 VLH_HaliteLookup::Pressure(){        return ValueOf(pressure_index); }
  double64 VLH_HaliteLookup::MassFractionNaCl(){return ValueOf(composition_index); }
  double64 VLH_HaliteLookup::Density(){         return ValueOf(density_index); }
  double64 VLH_HaliteLookup::Enthalpy(){        return ValueOf(enthalpy_index); }
  double64 VLH_HaliteLookup::HeatCapacity(){    return ValueOf(heatcapacity_index); }
  double64 VLH_HaliteLookup::Compressibility(){ return ValueOf(compressibility_index); }
  double64 VLH_HaliteLookup::Viscosity(){       return ValueOf(viscosity_index); }
    

  double64 VLH_HaliteLookup::TfromP(const double64& press, const double64& t_estimate)
  {
  ...
  double64 VLH_HaliteLookup::ValueOf(const int& property_index)
  {
  ...
  double64 VLH_HaliteLookup::DEnthalpyDT()
  {
  ...
  // data indexing
  // data indexing
  void VLH_HaliteLookup::GetTemperatureIndex(const double64& t){
    // new version
