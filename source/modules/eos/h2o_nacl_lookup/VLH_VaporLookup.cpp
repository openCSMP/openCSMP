        ...
        for(tcurrent = 0.0e0; tcurrent < 800.7e0; tcurrent += t_res)
          {
			...
			// PW 19.2.2016: changed from mass fraction to xNacl -> Check with Thomas
            //if(xcurrent < 1.0e-6)
			if (Massfraction2XNaCl(xcurrent) < 1.0e-6)
				{
				...
				// PW 19.2.2016: changed from bar to Pa -> Check with Thomas
                // if(pcurrent < 1.1)
			    if (pcurrent < 1.1e5)
					{
