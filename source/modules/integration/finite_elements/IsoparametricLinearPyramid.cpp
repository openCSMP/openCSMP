...
CSMP_FEM_TYPE
IsoparametricLinearPyramid::ElementTypeOfFace( uint32_t face ) const noexcept
 {
    assert( face < fpe );
...
double IsoparametricLinearPyramid::WeightAtIntegrationPoint( uint32_t i ) const noexcept { return W[i]; }
