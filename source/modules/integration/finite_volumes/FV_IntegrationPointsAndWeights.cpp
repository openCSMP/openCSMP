...
void FV_IntegrationPointsAndWeights<dim>::CreateDataFor_ISOPARAMETRIC_LINEAR_TET()
 {
   ...
   m_projection_weights[5][0]=0.0240110680599455104;
    ...
    const double64 facet_normal_transforms[6][2][4] = {
        { { -1.0/16.0,-1.0/16.0,-1.0/48.0,7.0/48.0 }, { -1.0/16.0,-1.0/16.0,7.0/48.0,-1.0/48.0 } },
        { { -1.0/48.0,-1.0/16.0,-1.0/16.0,7.0/48.0 }, { 7.0/48.0,-1.0/16.0,-1.0/16.0,-1.0/48.0 } },
        { { -1.0/16.0,-1.0/48.0,-1.0/16.0,7.0/48.0 }, { -1.0/16.0,7.0/48.0,-1.0/16.0,-1.0/48.0 } },
        { { -1.0/16.0,-1.0/48.0,7.0/48.0,-1.0/16.0 }, { -1.0/16.0,7.0/48.0,-1.0/48.0,-1.0/16.0 } },
        { { -1.0/48.0,-1.0/16.0,7.0/48.0,-1.0/16.0 }, { -7.0/48.0,1.0/16.0,1.0/48.0,1.0/16.0 } },
        { { 1.0/48.0,-7.0/48.0,1.0/16.0,1.0/16.0 }, { -7.0/48.0,1.0/48.0,1.0/16.0,1.0/16.0 } }
    };
...
void FV_IntegrationPointsAndWeights<dim>::CreateDataFor_ISOPARAMETRIC_LINEAR_HEX()
 {
   ...
   Resize( NumOfInternalFacets,
    ...
    const double64 facet_normal_transforms[12][2][8] = {
        { { -3.0/32.0, -3.0/32.0, -1.0/32.0, -1.0/32.0, 3.0/32.0, 3.0/32.0, 1.0/32.0, 1.0/32.0 },
          { -3.0/32.0, -3.0/32.0, 3.0/32.0, 3.0/32.0, -1.0/32.0, -1.0/32.0, 1.0/32.0, 1.0/32.0 } },
        { { -1.0/32.0, -3.0/32.0, -3.0/32.0, -1.0/32.0, 1.0/32.0, 3.0/32.0, 3.0/32.0, 1.0/32.0 },
          { 3.0/32.0, -3.0/32.0, -3.0/32.0, 3.0/32.0, 1.0/32.0, -1.0/32.0, -1.0/32.0, 1.0/32.0 } },
        { { -1.0/32.0, -1.0/32.0, -3.0/32.0, -3.0/32.0, 1.0/32.0, 1.0/32.0, 3.0/32.0, 3.0/32.0 },
          { 3.0/32.0, 3.0/32.0, -3.0/32.0, -3.0/32.0, 1.0/32.0, 1.0/32.0, -1.0/32.0, -1.0/32.0 } },
        { { -3.0/32.0, -1.0/32.0, -1.0/32.0, -3.0/32.0, 3.0/32.0, 1.0/32.0, 1.0/32.0, 3.0/32.0 },
          { -3.0/32.0, 3.0/32.0, 3.0/32.0, -3.0/32.0, -1.0/32.0, 1.0/32.0, 1.0/32.0, -1.0/32.0 } },
        { { -3.0/32.0, -1.0/32.0, 1.0/32.0, 3.0/32.0, -3.0/32.0, -1.0/32.0, 1.0/32.0, 3.0/32.0 },
          { -3.0/32.0, 3.0/32.0, 1.0/32.0, -1.0/32.0, -3.0/32.0, 3.0/32.0, 1.0/32.0, -1.0/32.0 } },
        { { 3.0/32.0, -3.0/32.0, -1.0/32.0, 1.0/32.0, 3.0/32.0, -3.0/32.0, -1.0/32.0, 1.0/32.0 },
        ...
        { { -1.0/32.0, 1.0/32.0, 3.0/32.0, -3.0/32.0, -1.0/32.0, 1.0/32.0, 3.0/32.0, -3.0/32.0 },
          { 3.0/32.0, 1.0/32.0, -1.0/32.0, -3.0/32.0, 3.0/32.0, 1.0/32.0, -1.0/32.0, -3.0/32.0 } },
        { { -1.0/32.0, -1.0/32.0, 1.0/32.0, 1.0/32.0, -3.0/32.0, -3.0/32.0, 3.0/32.0, 3.0/32.0 },
          { 3.0/32.0, 3.0/32.0, 1.0/32.0, 1.0/32.0, -3.0/32.0, -3.0/32.0, -1.0/32.0, -1.0/32.0 } },
        { { 1.0/32.0, -1.0/32.0, -1.0/32.0, 1.0/32.0, 3.0/32.0, -3.0/32.0, -3.0/32.0, 3.0/32.0 },
          { 1.0/32.0, 3.0/32.0, 3.0/32.0, 1.0/32.0, -1.0/32.0, -3.0/32.0, -3.0/32.0, -1.0/32.0 } },
        { { 1.0/32.0, 1.0/32.0, -1.0/32.0, -1.0/32.0, 3.0/32.0, 3.0/32.0, -3.0/32.0, -3.0/32.0 },
...
//	  const size_t NumberOfPhysicalDimensions(3U);
   ...
   // Facet normals pointing outside the internal face, all together 6 normals!
    ...
    const double64 facet_normal_transforms[9][2][6] = {
        { { -5.0/48.0, -5.0/48.0, -1.0/24.0, 5.0/48.0, 5.0/48.0, 1.0/24.0 },
          { -1.0/16.0, -1.0/16.0, 1.0/8.0, -1.0/48.0, -1.0/48.0, 1.0/24.0 } },
        { { -1.0/8.0, 1.0/16.0, 1.0/16.0, -1.0/24.0, 1.0/48.0, 1.0/48.0 },
          { -1.0/24.0, -5.0/48.0, -5.0/48.0, 1.0/24.0, 5.0/48.0, 5.0/48.0 } },
        { { 1.0/16.0, -1.0/8.0, 1.0/16.0, 1.0/48.0, -1.0/24.0, 1.0/48.0 },
          { -5.0/48.0, -1.0/24.0, -5.0/48.0, 5.0/48.0, 1.0/24.0, 5.0/48.0 } },
        { { -1.0/12.0, -1.0/48.0, 5.0/48.0, -1.0/12.0, -1.0/48.0, 5.0/48.0 },
          { -1.0/12.0, 5.0/48.0, -1.0/48.0, -1.0/12.0, 5.0/48.0, -1.0/48.0 } },
        { { 5.0/48.0, -1.0/12.0, -1.0/48.0, 5.0/48.0, -1.0/12.0, -1.0/48.0 },
          { -1.0/48.0, -1.0/12.0, 5.0/48.0, -1.0/48.0, -1.0/12.0, 5.0/48.0 } },
        { { -1.0/48.0, 5.0/48.0, -1.0/12.0, -1.0/48.0, 5.0/48.0, -1.0/12.0 },
          { 5.0/48.0, -1.0/48.0, -1.0/12.0, 5.0/48.0, -1.0/48.0, -1.0/12.0 } },
        { { -1.0/48.0, -1.0/48.0, 1.0/24.0, -1.0/16.0, -1.0/16.0, 1.0/8.0 },
          { 5.0/48.0, 5.0/48.0, 1.0/24.0, -5.0/48.0, -5.0/48.0, -1.0/24.0 } },
        { { 1.0/24.0, -1.0/48.0, -1.0/48.0, 1.0/8.0, -1.0/16.0, -1.0/16.0 },
          { 1.0/24.0, 5.0/48.0, 5.0/48.0, -1.0/24.0, -5.0/48.0, -5.0/48.0 } },
        { { -1.0/48.0, 1.0/24.0, -1.0/48.0, -1.0/16.0, 1.0/8.0, -1.0/16.0 },
          { 5.0/48.0, 1.0/24.0, 5.0/48.0, -5.0/48.0, -1.0/24.0, -5.0/48.0 } }
    };
...
void FV_IntegrationPointsAndWeights<dim>::CreateDataFor_ISOPARAMETRIC_LINEAR_PYR()
{
   ...
   m_projection_weights[4][0]=m_projection_weights[5][0]=m_projection_weights[6][0]=m_projection_weights[7][0]=0.2085503283484722;
    ...
    const double64 facet_normal_transforms[12][2][5] = {
        { { -11.0/192.0, -11.0/192.0, -1.0/64.0, -1.0/64.0, 7.0/48.0 },
            { -19.0/192.0, -19.0/192.0, 7.0/64.0, 7.0/64.0, -1.0/48.0 } },
        { { -1.0/64.0, -11.0/192.0, -11.0/192.0, -1.0/64.0, 7.0/48.0 },
            { 7.0/64.0, -19.0/192.0, -19.0/192.0, 7.0/64.0, -1.0/48.0 } },
        { { -1.0/64.0, -1.0/64.0, -11.0/192.0, -11.0/192.0, 7.0/48.0 },
            { 7.0/64.0, 7.0/64.0, -19.0/192.0, -19.0/192.0, -1.0/48.0 } },
        { { -11.0/192.0, -1.0/64.0, -1.0/64.0, -11.0/192.0, 7.0/48.0 },
            { -19.0/192.0, 7.0/64.0, 7.0/64.0, -19.0/192.0, -1.0/48.0 } },
        { { -7.0/96.0, 3.0/32.0, 3.0/32.0, -7.0/96.0, -1.0/24.0 },
            { 1.0/12.0, 0.0, 0.0, -1.0/6.0, 1.0/12.0 } },
        { { -5.0/32.0, 3.0/32.0, 3.0/32.0, 3.0/32.0, -1.0/8.0 },
            { -1.0/12.0, 1.0/6.0, 0.0, 0.0, -1.0/12.0 } },
        { { -7.0/96.0, -7.0/96.0, 3.0/32.0, 3.0/32.0, -1.0/24.0 },
            { -1.0/6.0, 1.0/12.0, 0.0, 0.0, 1.0/12.0 } },
        { { 3.0/32.0, -5.0/32.0, 3.0/32.0, 3.0/32.0, -1.0/8.0 },
            { 0.0, -1.0/12.0, 1.0/6.0, 0.0, -1.0/12.0 } },
        { { 3.0/32.0, -7.0/96.0, -7.0/96.0, 3.0/32.0, -1.0/24.0 },
            { 0.0, -1.0/6.0, 1.0/12.0, 0.0, 1.0/12.0 } },
        { { 3.0/32.0, 3.0/32.0, -5.0/32.0, 3.0/32.0, -1.0/8.0 },
            { 0.0, 0.0, -1.0/12.0, 1.0/6.0, -1.0/12.0 } },
        { { 3.0/32.0, 3.0/32.0, -7.0/96.0, -7.0/96.0, -1.0/24.0 },
            { 0.0, 0.0, -1.0/6.0, 1.0/12.0, 1.0/12.0 } },
        { { 3.0/32.0, 3.0/32.0, 3.0/32.0, -5.0/32.0, -1.0/8.0 },
            { 1.0/6.0, 0.0, 0.0, -1.0/12.0, -1.0/12.0 } }
    };
    m_facet_normal_xforms.resize(12u);
    for (size_t f = 0; f < 12u; ++f) {
