    ...
    prefactor_(prefactor)
{
    ...
    throw csmp::Exception( CSMP_ERROR, "Jacobian_Upwind_Integral_dNT_op_dN_dV::(constructor)", 
...
void Jacobian_Upwind_Integral_dNT_op_dN_dV<dim,SIMPLEX>::GetOperands( SIMPLEX& e )
 {
  ...
  if (upwind_.place == NODE && upwind_.type == SCALAR && trigger_.place == NODE && trigger_.type == SCALAR) {
    ...
    throw csmp::Exception( CSMP_FATAL_ERROR, "Jacobian_Upwind_Integral_dNT_op_dN_dV<dim>::GetOperands", 
