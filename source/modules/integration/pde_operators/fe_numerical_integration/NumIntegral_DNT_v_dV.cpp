...
NumIntegral_DNT_v_dV<dim,SIMPLEX>::NumIntegral_DNT_v_dV( const PropertyDatabase<dim>& pref,
...
*/
template<size_t dim,class SIMPLEX>
void NumIntegral_DNT_v_dV<dim,SIMPLEX>::ComputeContribution( SIMPLEX& e )
{
