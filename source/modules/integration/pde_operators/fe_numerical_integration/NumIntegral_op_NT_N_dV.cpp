...
NumIntegral_op_NT_N_dV<dim,CELL>::NumIntegral_op_NT_N_dV( const PropertyDatabase<dim>& pref,
...
template<size_t dim,class CELL>
void NumIntegral_op_NT_N_dV<dim,CELL>::ComputeContribution( const CELL& e )
{
