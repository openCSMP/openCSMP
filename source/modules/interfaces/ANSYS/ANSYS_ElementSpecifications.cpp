...
std::string  parse_ANSYS_BoundaryFlag( int8_t i )
 {
    ...
    if ( i == CNR_MIN_MAXX )    return string("CNR2");
    if ( i == CNR_MAX_MAXX )    return string("CNR3");
    if ( i == CNR_MAX_MINXZ )   return string("CNR4");
    if ( i == CNR_MIN_MAXZ )    return string("CNR5");
    if ( i == CNR_MIN_MAXXZ )   return string("CNR6");
    if ( i == CNR_MAX )         return string("CNR7");
    if ( i == CNR_MAX_MAXZ )    return string("CNR8");
