...
//  CSMP_GitHub
//
//  Created by Stephan Matthai on 16/09/2016.
...
const fT SparseMatrix<iT,fT>::zero_(0.);

//! epsilon: a very very small number number greater than zero
template <typename iT, typename fT>
const fT SparseMatrix<iT,fT>::eps_(numeric_limits<fT>::epsilon());
...
template class csmp::SparseMatrix<int,double>;
template class csmp::SparseMatrix<unsigned int,double>;
