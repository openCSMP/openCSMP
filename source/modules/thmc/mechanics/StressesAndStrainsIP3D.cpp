#include "StressesAndStrainsIP3D.h"
#include "mechanics.h"
#include "Face.h"
#include "InterFace.h"
#include "Region.h"
...
StressesAndStrainsIP3D::StressesAndStrainsIP3D( const Model<3U>& sg,
  ...
  : MathOperatorLHS<3U>(sg.Database(),oper,basic,test),
    ...
    verbose_(false)
 {
    MathOperatorLHS<3U>::Name("StressesAndStrainsIP3D", oper, basic, test );
   ...
   // principal stresses and strains (must all be element integration point properties)
    ...
    MathOperatorLHS<3U>::ApplicationCycles(1);
...
void StressesAndStrainsIP3D::PrincipalStrainsAndStresses( bool yes_no )
 {
...
*/
void StressesAndStrainsIP3D::GetOperands( const Element<3U>& e )
{
   ...
   // 2. collecting nodal displacements into a matrix of size nodes * dof x 1
...
*/
void StressesAndStrainsIP3D::ComputeContribution( const Element<3U>& e )
{
   ...
   // -------------------------------------------------------------------
  if ( verbose_ )
    cout <<"\n\nStressesAndStrainsIP3D::ComputeContribution: Element: "<< e.Idx() << endl;
...
*/
void StressesAndStrainsIP3D::WriteOperands( Element<3U>& e )
 {
