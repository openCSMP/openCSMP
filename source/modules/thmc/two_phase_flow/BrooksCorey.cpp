...
template<size_t dim>
double64 BrooksCorey<dim>::krw_Phase() const
 { 
...
template<size_t dim>
double64 BrooksCorey<dim>::krn_Phase() const
 { 
    //  switch to linear relperm model if lambda = 0
    if ( lambda_ == static_cast<double64>(0.) )
...
template<size_t dim>
double64 BrooksCorey<dim>::dkrwds_Phase() const
 {
...
template<size_t dim>
double64 BrooksCorey<dim>::dkrnds_Phase() const
 {
    const double64 seff_mult( 1.0/ (1.0 - TwoPhaseModel<dim>::swr_ - TwoPhaseModel<dim>::snr_ ) );
...
template<size_t dim>
double64 BrooksCorey<dim>::pc_Phase( ) const
{
...
template<size_t dim>
double64 BrooksCorey<dim>::dpcds_Phase( ) const
{
...
template<size_t dim>
double64 BrooksCorey<dim>::Sw_Phase( double64 pc ) const
{
...
template<size_t dim>
double64 BrooksCorey<dim>::dsdpc_Phase( double64 pc ) const
{
...
template<size_t dim>
double64 BrooksCorey<dim>::dfds() const
{
...
template<size_t dim>
double64 BrooksCorey<dim>::dGds() const
{
...
template<size_t dim>
double64 BrooksCorey<dim>::MaxFractionalFlowDerivative() const
 {
    // linear relperm model
...
template<size_t dim>
double64 BrooksCorey<dim>::ShockSpeed() const
 {
    if ( lambda_ == static_cast<double64>(0.) )
    {
...
template<size_t dim>
double64 BrooksCorey<dim>::ShockHeight() const
 {
...
template<size_t dim>
void BrooksCorey<dim>::Out( std::ostream& os, size_t phase ) const
 {
