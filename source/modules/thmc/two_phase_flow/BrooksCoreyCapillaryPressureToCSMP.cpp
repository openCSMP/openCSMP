#include <cmath>
#include "BrooksCoreyCapillaryPressureandPermeability.h"
...
template<size_t dim, template<size_t> class USER>
template<class TARGET_PLACEMENT> double64 BrooksCoreyCapillaryPressure::WaterRelativePermebility( TARGET_PLACEMENT& p ) {
...
template<size_t dim, template<size_t> class USER>
template<class TARGET_PLACEMENT> double64 BrooksCoreyCapillaryPressure::OilRelativePermebility( TARGET_PLACEMENT& p) {
...
template<size_t dim, template<size_t> class USER>
template<class TARGET_PLACEMENT> double64 BrooksCoreyCapillaryPressure::FirstDerivativeWaterRelativePermebility( TARGET_PLACEMENT& p ) {
...
template<size_t dim, template<size_t> class USER>
template<class TARGET_PLACEMENT> double64 BrooksCoreyCapillaryPressure::FirstDerivativeOilRelativePermebility( TARGET_PLACEMENT& p) {
