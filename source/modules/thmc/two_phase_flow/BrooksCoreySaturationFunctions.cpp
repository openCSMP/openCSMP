...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::EffectiveSaturation( ElementPlacement<3U,NODE>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::EffectiveSaturation( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::EffectiveSaturation( ElementPlacement<3U,FACET_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::EffectiveSaturation( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::SeffToSw( ElementPlacement<3U,NODE>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::SeffToSw( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::SeffToSw( ElementPlacement<3U,FACET_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::SeffToSw( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>&, double64 ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::krw( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::krw( ElementPlacement<3U,FACET_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::krn( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::krn( ElementPlacement<3U,FACET_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrwds( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrwds( ElementPlacement<3U,FACET_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrnds( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrnds( ElementPlacement<3U,FACET_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::pc( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::pc( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dpcds( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dpcds( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>& ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::Sw( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::Sw( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>&, double64 ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dsdpc( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dsdpc( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>&, double64 ) const;
...
{
   const double64 dSedSw(1./(1. - p.Interpolate(User()->key_SWR) - p.Interpolate(User()->key_SNR)));
   const double64 seff(EffectiveSaturation(p));
   const double64 bcp(p.Interpolate(User()->key_bcp));
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrwds_Numerical( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrwds_Numerical( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>&, double64 ) const;
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrnds_Numerical( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dkrnds_Numerical( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>&, double64 ) const;
...
{
   const double64 sw(p.Interpolate(User()->key_sw));
   const double64 swr(p.Interpolate(User()->key_SWR)), snr(p.Interpolate(User()->key_SNR));
   const double64 bcp(p.Interpolate(User()->key_bcp));
...
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dpcds_Numerical( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>&, double64 ) const;
template double64 BrooksCoreySaturationFunctions<3U,FlowFunctions>::dpcds_Numerical( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>&, double64 ) const;
...
template void BrooksCoreySaturationFunctions<3U,FlowFunctions>::Out( ElementPlacement<3U,ELEMENT_INTEGRATION_POINT>& ) const;
template void BrooksCoreySaturationFunctions<3U,FlowFunctions>::Out( ElementPlacement<3U,SECTOR_INTEGRATION_POINT>& ) const;
