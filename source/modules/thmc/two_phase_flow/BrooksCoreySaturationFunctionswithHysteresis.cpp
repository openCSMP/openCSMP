...
aw_(aw),ao_(ao),cw_(cw),co_(co)
{
  ...
  template void BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::InitialiseBrooksCoreyParameters( FiniteElementPlacement<1U,ELEMENT>& ) ;
  template void BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::InitialiseBrooksCoreyParameters( FiniteVolumePlacement<1U,NODE>& ) ;
  ...
  template void BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::InitialiseBrooksCoreyParameters( FiniteElementPlacement<1U,ELEMENT>&, double64, double64,  double64, double64 ) ;
  template void BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::InitialiseBrooksCoreyParameters( FiniteVolumePlacement<1U,NODE>&, double64, double64,  double64, double64 ) ;
    ...
    template void BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::InitialiseBrooksCoreyParameters( FiniteElementPlacement<1U,ELEMENT>&, double64 a[2][2] , double64 c[2][2], process ProcessPath) ;
    template void BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::InitialiseBrooksCoreyParameters( FiniteVolumePlacement<1U,NODE>&, double64 a[2][2], double64 c[2][2], process ProcessPath) ;
    ...
    template double64 BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::EffectiveSaturation( FiniteElementPlacement<1U,ELEMENT>& ) const ;
    template double64 BrooksCoreySaturationFunctionsWithHysteresis<1U,FlowFunctionsDraft2>::EffectiveSaturation( FiniteVolumePlacement<1U,NODE>& ) const ;
