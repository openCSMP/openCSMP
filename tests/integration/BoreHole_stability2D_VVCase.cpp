...
//       cout << "xy[1] " << xy[1] <<endl;
       ...
       for ( vector<Element<2U>*>::const_iterator it( model.Region("Model").ElementsBegin() ); it != model.Region("Model").ElementsEnd(); ++it  )
...
//       cout << "xy[1] " << xy[1] <<endl;
       ...
       for ( vector<Element<2U>*>::const_iterator it( model_domain.ElementsBegin() ); it != model_domain.ElementsEnd(); ++it  )
       {
