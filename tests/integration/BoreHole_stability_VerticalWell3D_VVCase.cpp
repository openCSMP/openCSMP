...
MohrCoulombFailure_Visitor<3U> failureTest(model, true /* positive compressive stress convention */, false/* verbose mode */); //friction angle 31 degree -->0.6 friction coefficient
