...
bool Colony_Test::TestColonyWith_int()
{
   ...
   cout <<"\nmain: colony pointer vector:\n"; // non-deleted elements are still valid
   for ( size_t n{0}; n<int_ptrs.size(); ++n ) cout <<" "<< *int_ptrs[n];
   cout << endl;
...
bool Colony_Test::TestColonyWith_Element2()
 {
