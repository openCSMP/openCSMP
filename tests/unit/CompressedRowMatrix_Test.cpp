...
namespace csmp
{
  void CompressedRowMatrix_Test::run()
  {
    ...
    getInfoStream()<<"Matrix A set up"<<endl;
	...
	getInfoStream() << "Printing the testMatrix1 initialized by A using the '()' operator:\n";
	getInfoStream() << testMatrix1(0, 0) << " " << testMatrix1(0, 1) << " " << testMatrix1(0, 2) << " " << testMatrix1(0, 3) << endl;;
	getInfoStream() << testMatrix1(1, 0) << " " << testMatrix1(1, 1) << " " << testMatrix1(1, 2) << " " << testMatrix1(1, 3) << endl;;
	getInfoStream() << testMatrix1(2, 0) << " " << testMatrix1(2, 1) << " " << testMatrix1(2, 2) << " " << testMatrix1(2, 3) << endl;;
	getInfoStream() << testMatrix1(3, 0) << " " << testMatrix1(3, 1) << " " << testMatrix1(3, 2) << " " << testMatrix1(3, 3) << endl;;

	getInfoStream() << "Printing the testMatrix2 initialized for a PointBased approach\n";
	getInfoStream() << testMatrix1(0, 0) << " " << testMatrix1(0, 1) << " " << testMatrix1(0, 2) << " " << testMatrix1(0, 3) << endl;;
	getInfoStream() << testMatrix1(1, 0) << " " << testMatrix1(1, 1) << " " << testMatrix1(1, 2) << " " << testMatrix1(1, 3) << endl;;
	getInfoStream() << testMatrix1(2, 0) << " " << testMatrix1(2, 1) << " " << testMatrix1(2, 2) << " " << testMatrix1(2, 3) << endl;;
	getInfoStream() << testMatrix1(3, 0) << " " << testMatrix1(3, 1) << " " << testMatrix1(3, 2) << " " << testMatrix1(3, 3) << endl;;

	getInfoStream() << "Printing the testMatrix3 initialized by testMatrix1 using the '=' operator:\n";
	getInfoStream() << testMatrix1(0, 0) << " " << testMatrix1(0, 1) << " " << testMatrix1(0, 2) << " " << testMatrix1(0, 3) << endl;;
	getInfoStream() << testMatrix1(1, 0) << " " << testMatrix1(1, 1) << " " << testMatrix1(1, 2) << " " << testMatrix1(1, 3) << endl;;
	getInfoStream() << testMatrix1(2, 0) << " " << testMatrix1(2, 1) << " " << testMatrix1(2, 2) << " " << testMatrix1(2, 3) << endl;;
	getInfoStream() << testMatrix1(3, 0) << " " << testMatrix1(3, 1) << " " << testMatrix1(3, 2) << " " << testMatrix1(3, 3) << endl;;
    ...
    getInfoStream() <<"End of testMatrix1.out()"<<endl;
