...
//      _test( e.IsWithinRange( kt1, 2., 4. ) );
      ...
      Index ka1( ARRAY, ELEMENT, 0, 14, 0 ); // offset to data start / size / offset to flag
      Index ka2( ARRAY, ELEMENT, 14, 6, 1 );
      ...
      Index ka3( ARRAY, ELEMENT, 20, 8, 2 );
      e3.AddProperty(ka3);
      ArrayVariable av3(8);
      e3.Read( ka3, av0 );
      _test( av0 == av3 );

      Index ka4( ARRAY, ELEMENT, 28, 16, 3 );
      e3.AddProperty(ka4);
      av3.Size(16);
      e3.Read( ka4, av0 );
      _test( av0 == av3 );
      ...
      e3.Store( ka3, av3 );
      e3.Store( ka4, av4 );
      e3.DeleteProperty(ka3); // now indices have to be updated for offset, so that a1 = a1, a2 = a2, a3 = a4
