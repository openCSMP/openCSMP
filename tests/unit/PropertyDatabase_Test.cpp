...
namespace csmp
{
    ...
    void PropertyDatabase_Test::NameTest(csmp::Index idx,const char* name)
    {
        _test(strcmp(pdb->Name(idx),name)==0);
    }


    void PropertyDatabase_Test::UnitTest(csmp::Index idx, const char* unit)
    {
    ...
    {        
        csmp::Index idx;
        idx=pdb->AddProperty("test variable","m s-1",VECTOR,REGION);
