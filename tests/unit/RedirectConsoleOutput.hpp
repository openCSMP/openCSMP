...
#ifndef REDIRECT_CONSOLE_OUTPUT_H
#define REDIRECT_CONSOLE_OUTPUT_H
...
/**
    From Sir Dickby Chicken Ceasar - stack overflow post:
    redirect stdout/stderr to a string (2014)
...
TODO:  not sure where the types STD_OUT_FD and STD_ERR_FD are defined; figure out.
...
#endif /* REDIRECT_CONSOLE_OUTPUT_H */
