...
bool SplitBoundary_Test::Test_NodeCorrespondance_Intersection_3D( const char* mesh_file){
  ...
  //Region -> SplitBoundary
  string sb_name1  = *((model1.CreateSplitBoundaryFrom( "FRACTURE_PLANAR" ) ).first.begin()) ;
  //string sb_name2  = *((model1.CreateSplitBoundaryFrom( "FRACTURE_DIAGONAL" ) ).first.begin()) ;
