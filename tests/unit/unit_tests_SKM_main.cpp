...
int main()
{
  ...
  try {
    ...
    s.addTest( new PoreSpaceModel_Test() );
//    s.addTest( new BoundaryFunctionality_Test() );
//    s.addTest( new Boundary_Test() );
//    s.addTest( new SplitBoundary_Test() );
...
//    s.addTest( new BinaryFileInterface_Test() ); // broken: logic of the test is not clear
    //s.addTest( new InputDataManager_Test());
//    s.addTest( new Region_Test() );                  // SKM OK

// TODO: fix:    s.addTest( new Boundary_Test() );
