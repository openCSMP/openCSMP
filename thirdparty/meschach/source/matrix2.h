...
*/
  ...
  VEC     *bdLUsolve(BAND *A,PERM *pivot,VEC *b,VEC *x),
	...
	VEC	*rot_vec(VEC *,u_int,u_int,double,double,VEC *); /* in situ */
	MAT	*rot_rows(MAT *,u_int,u_int,double,double,MAT *); /* in situ */
	MAT	*rot_cols(MAT *,u_int,u_int,double,double,MAT *); /* in situ */
