...
static char rcsid[] = "$Id: schur.c,v 1.1.1.1 2006/08/09 13:57:52 apaluszn Exp $";
	...
	while ( ! split )
	{
	    ...
	    ********************/
		...
		if ( k < k_max - 1 )
		{
		    ...
		    tracecatch(hhldr3cols(A,k,ms_max(k-1,0),  beta2,nu1,y,z),"schur");
		    tracecatch(hhldr3rows(A,k,ms_min(n-1,k+3),beta2,nu1,y,z),"schur");
		    if ( Q != MNULL )
